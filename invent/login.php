    ...
    <div class="login-wrapper">
        <form class="login-form" action="" method="post">
            <div class="form-group">
                <input type="text" name="member_id" maxlength="100" placeholder="アカウント名" class="form-control" value=''>
            </div>
            <div class="form-group">
                <input type="password" name="password" maxlength="100" placeholder="パスワード" class="form-control" value=''>
            </div>
            <div class="form-group">
